...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [SYMBOL] = LAYOUT(
    ...
    KC_HASH,  KC_CIRC,     KC_EQL,     KC_SLSH,     KC_DLR,     KC_ASTR,                                                                      KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,
    KC_AT,  KC_LT,     KC_PIPE,     KC_MINS,     KC_GT,     KC_UNDS,                                                                      KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,
