...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[SYMBOL] = LAYOUT_split_3x6_5(
		...
		KC_HASH, KC_CIRC, KC_EQL, KC_SLSH, KC_DLR, KC_ASTR, KC_DOT, KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI, KC_NO,
		KC_AT, KC_LT, KC_PIPE, KC_MINS, KC_GT, KC_UNDS, KC_TILD, KC_BSLS, KC_TRNS, KC_NO, KC_SCLN, KC_DEL, LSFT(KC_TAB), KC_LPRN, KC_RPRN, KC_EQL,
	...
	[MISC] = LAYOUT_split_3x6_5(
		...
		LGUI(KC_3), LCTL(KC_4), LCTL(KC_3), LCTL(KC_2), LCTL(KC_1), LCTL(KC_5), LSFT(KC_INS), KC_NO, KC_NO, KC_NO, COPY_NEW_TAB, VIM_SAVE, KC_NO, KC_NO, KC_NO, KC_NO,
