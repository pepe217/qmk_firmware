...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_B,  MT(MOD_LGUI, KC_C),  MT(MOD_LALT, KC_I),  MT(MOD_LCTL, KC_E),  MT(MOD_LSFT, KC_A),  KC_COMM,  KC_K,   MT(MOD_RSFT, KC_H),  MT(MOD_RCTL, KC_T),  MT(MOD_RALT, KC_N),  MT(MOD_RGUI, KC_S),  KC_V,
        QK_LLCK,KC_QUOT, KC_SLSH, LT(CURSOR,KC_EQL),KC_UNDS, KC_DOT, KC_ESC, KC_HOME,                         KC_END, KC_ENT, KC_J,   KC_M ,LT(SYMBOL,KC_G), KC_P ,KC_F, QK_LLCK,
        KC_LPRN, KC_RPRN, LT(CURSOR, KC_SPC), LT(NUMPAD, KC_TAB), CW_TOGG,   KC_DEL , KC_BSPC ,LT(MOUSE, KC_R), KC_PGUP, KC_PGDN
    ),
    [SYMBOL] = LAYOUT(
        KC_LBRC, KC_EXLM, KC_LCBR, KC_RCBR, KC_COMM, KC_QUES,                 KC_GRV, KC_DEL, LSFT(KC_TAB), KC_INS, KC_ESC, KC_NO,
        KC_HASH, KC_CIRC, KC_LBRC, KC_RBRC, KC_DLR, KC_ASTR,                  KC_DQT, KC_BSPC, KC_TAB, KC_SPACE, KC_ENTER, KC_NO,
        KC_TILDE, KC_LT, KC_PIPE, KC_MINUS, KC_GT, KC_SLSH, KC_BSLS, KC_DOT,    KC_NO   ,KC_NO   ,KC_NO   ,KC_QUOT, KC_NO, KC_NO, KC_NO, KC_TRNS,
    ...
    [NUMPAD] = LAYOUT(
        ...
        KC_B, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_E, KC_NO, KC_NO,                         KC_NO, KC_NO, K, KC_4, KC_5, KC_6, KC_MINS, KC_PLUS,
                KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS,   KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS
    ),
    [CURSOR] = LAYOUT(
        LGUI(KC_1), KC_8, KC_7, KC_6, KC_0, KC_9,                                                             KC_NO, KC_NO, KC_NO, KC_NO, TO(MAC_ENGRAM), TO(ENGRAM),
        LGUI(KC_2), KC_4, KC_3, KC_2, KC_1, KC_5,                                                             KC_NO, KC_LEFT, KC_UP, KC_DOWN, KC_RIGHT, KC_NO,
        LGUI(KC_3), LCTL(KC_4), LCTL(KC_3), LCTL(KC_2), LCTL(KC_1), LCTL(KC_5), KC_NO, KC_HOME,                   KC_PGUP, KC_PGDN, KC_END,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
                KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   , KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS
    ),
    [MOUSE] = LAYOUT(
